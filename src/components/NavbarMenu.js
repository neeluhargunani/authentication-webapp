 ...
 class NavbarMenu extends Component {
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    <Nav className="mr-auto">
      ...
      <Nav.Link><Link to="/userlist"><FontAwesomeIcon icon={faList}/><span>UserList</span></Link></Nav.Link>
      <Nav.Link><Link to="/productlist"><FontAwesomeIcon icon={faList}/><span>ProductList</span></Link></Nav.Link>
    
      
      <Nav.Link><Link to="/adminlogin"><FontAwesomeIcon icon={faUserPlus}/><span> AdminLogin</span></Link></Nav.Link>
